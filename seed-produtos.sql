...
values
  ('Eau de Parfum Noir','Maison Lumière','França','cosmeticos',589,820,'-30%','🧴','',4.9,214,'Tamanho',
  ...
  ('Fone Bluetooth ANC Pro','AudioLab','EUA','audio',749,999,'-25%','🎧','',4.8,512,'Cor',
  ...
  ('Smartphone Ultra 256GB','Nexon','Coreia do Sul','eletronicos',3299,3899,'','📱','',4.7,88,'Armazenamento',
  ...
  ('Bike Elétrica Urban 350W','VoltRide','Alemanha','mobilidade',6490,7490,'-13%','🚲','',4.9,37,'Tamanho do quadro',
  ...
  ('Mala de Bordo Rígida 20"','TravelCo','Itália','viagem',459,640,'-28%','🧳','',4.6,156,'Cor',
  ...
  ('Perfume Floral Blossom 75ml','Fleur Paris','França','cosmeticos',399,520,'','🌸','',4.9,301,'Tamanho',
  ...
  ('Earbuds True Wireless Mini','AudioLab','EUA','audio',289,389,'-26%','🎵','',4.7,420,'Cor',
  ...
  ('Smartphone Lite 128GB','Nexon','Coreia do Sul','eletronicos',1799,2099,'','📲','',4.6,143,'Armazenamento',
